...
function Footer() {
  ...
  return (
    <div className='bg-black text-gray-300 py-10 px-6'>
       <div className='max-w-7xl mx-auto flex lg:items-center items-start justify-center gap-[40px] lg:gap-[150px] flex-xol lg:flex-row'>

         <div className='lg:w-[40px] md:w-[50%] w-[100%]'>
