          ...
          <div className="w-[100%] min-h-screen p-4 sm:p-6 bg-gray-100">
                ...
                <tbody >
                    ...
                    <tr key={index} className="border-b hover:bg-gray-50 transition duration-200">
                       ...
                       {course?.price?  <td className="px-4 py-3">₹{course.price}</td>:
                        ...
                        <td className="px-4 py-3"><span className={`px-3 py-1 rounded-full text-xs ${course.isPublished?"bg-green-100 text-green-600":"bg-red-100 text-red-500"}`}>{course.isPublished?"Published":"Draft"}</span></td>
             ...
             <div className="md:hidden space-y-4 ">
                ...
                <div key={index}className="bg-white rounded-lg shadow p-4 flex flex-col gap-3">
                  ...
                  <span className={`w-fit px-3 py-1 text-xs rounded-full ${course?.isPublished?"bg-green-100 text-green-600":"bg-red-100 text-red-500"}`}>{course?.isPublished?"Published":"Draft"}</span>
                </div>))}
