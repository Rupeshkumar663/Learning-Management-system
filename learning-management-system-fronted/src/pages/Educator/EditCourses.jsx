          ...
          <div className="flex gap-2 mt-2">
           ...
           <form className="space-y-6" onSubmit={(e)=>e.preventDefault()}>
             ...
             <div>
                ...
                <textarea type="text" id="dis" className='w-full border px-4 py-2 rounded-md h-24 resize-none'placeholder="Course Description" onChange={(e)=>setDescription(e.target.value)} value={description}></textarea>
             </div>
